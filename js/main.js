...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    for (var i = 0; i < document.getElementsByClass(".randomPizzaContainer").length; i++) {
      var dx = determineDx(document.getElementsByClass(".randomPizzaContainer")[i], size);
      var newwidth = (document.getElementsByClass(".randomPizzaContainer")[i].offsetWidth + dx) + 'px';
      document.getElementsByClass(".randomPizzaContainer")[i].style.width = newwidth;
    }
  }
...
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    var phase = Math.random(1,2,3,4,5);
